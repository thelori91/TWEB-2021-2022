...
@WebServlet(name = "rmvCourseServlet", value = "/rmvCourse-servlet")
public class RmvCourseServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                if (DAO.logInFunction(user, password) && DAO.getRole(user, password) == Role.ADMIN) {
                    ...
                    DAO.rmvCourse(course);
                    out.println("Success:");
                    out.println("Course removed correctly");
                }
                ...
                out.println("Error:");
                out.println("Cannot remove Course");
            }
        } catch (IOException e) {
